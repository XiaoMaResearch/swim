...
#include "ReverseAuxValue.h"

registerMooseObject("swimApp", ReverseAuxValue);

template <>
InputParameters
validParams<ReverseAuxValue>()
{
  InputParameters params = validParams<AuxKernel>();
  params.addClassDescription("Calculating the sea floor profile using H 0-H");
...
ReverseAuxValue::ReverseAuxValue(const InputParameters & parameters)
