...
#ifndef VARGRADCOUPLE_H
#define VARGRADCOUPLE_H
 ...
 */
template <>
InputParameters validParams<VarGradCouple>();
 ...
 */
class VarGradCouple : public Kernel
{
public:
  /**
   ...
   */
  VarGradCouple(const InputParameters & parameters);
