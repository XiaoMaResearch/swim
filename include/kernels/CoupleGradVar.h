...
#ifndef COUPLEGRADVAR_H
#define COUPLEGRADVAR_H
 ...
 */
template <>
InputParameters validParams<CoupleGradVar>();
 ...
 */
class CoupleGradVar : public Kernel
{
public:
  /**
   ...
   */
  CoupleGradVar(const InputParameters & parameters);
