...
#ifndef COUPLEGRADCOUPLE_H
#define COUPLEGRADCOUPLE_H
 ...
 */
template <>
InputParameters validParams<CoupleGradCouple>();
 ...
 */
class CoupleGradCouple : public Kernel
{
public:
  /**
   ...
   */
  CoupleGradCouple(const InputParameters & parameters);
