...
[Functions]
    ...
    [./Intial_H]
        type = ParsedFunction
        value = '1000-(A*exp(-((x-(x_0+v*t))*(x-(x_0+v*t))/(2*sigma_x*sigma_x)+(y-y_0)*(y-y_0)/(2*sigma_y*sigma_y))))+(k_slope*(x-x_transit)*(x>=x_transit)+0*(x<x_transit))'
        vars = 'A x_0 y_0 sigma_x sigma_y k_slope v x_transit k_slope'
        vals = '1.0 -50.0 0.0 10.0 10.0 1.0 1000 0 10.0'
    [../]
